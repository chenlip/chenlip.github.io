...
* 安全提示，这里的后端代码并未做发送者的身份认证，理论上通过这个webapi，谁都可以发送消息。鉴于我们目前在内网使用（这个excel文件你复制到互联网实际上是用不了的），暂时不考虑安全性了。
...
![image-20211125135953785](https://chenlip.github.io/css/Img/image-20211125135953785.png)
